export const en = {
  ...
  'progress.measurements.datePlaceholder': 'YYYY-MM-DD',
  ...
  'sync.conflicts.screenTitle': 'Changes to review',
  'sync.conflicts.intro':
    'The same record changed here and in your account. Choose the version you want to keep — nothing changes until you do.',
  'sync.conflicts.loading': 'Loading your changes…',
  'sync.conflicts.emptyTitle': 'Nothing to review',
  'sync.conflicts.emptyBody':
    'Your records match on this device and in your account. Anything that needs a decision will show up here.',
  'sync.conflicts.errorTitle': "We couldn't load your changes",
  'sync.conflicts.errorBody':
    'Something went wrong while opening this list. Nothing was changed, and everything is still saved.',
  'sync.conflicts.choiceErrorTitle': "We couldn't save your choice",
  'sync.conflicts.choiceErrorBody': 'Nothing changed. Review the options and try again.',
  'sync.conflicts.retry': 'Try again',
  'sync.conflicts.retryAccessibility': 'Try loading your changes again',
  'sync.conflicts.side.thisDevice': 'On this device',
  'sync.conflicts.side.account': 'Saved in your account',
  'sync.conflicts.meta.record': 'Record',
  'sync.conflicts.meta.entryDate': 'Entry date',
  'sync.conflicts.meta.startingVersion': 'You started from version',
  'sync.conflicts.meta.accountVersion': 'Your account is on version',
  'sync.conflicts.meta.noticed': 'Noticed',
  'sync.conflicts.meta.status': 'Status',
  'sync.conflicts.status.undecided': 'Waiting for you',
  'sync.conflicts.status.choiceRecorded': 'Saving your choice',
  'sync.conflicts.status.retrying': "We'll try again",
  'sync.conflicts.status.blocked': 'Needs another option',
  'sync.conflicts.status.settled': 'Done',
  'sync.conflicts.pendingTitle': 'Your choice is saved',
  'sync.conflicts.pendingBody':
    "We'll finish this the next time you're connected. You don't need to do anything else.",
  'sync.conflicts.failedTitle': "We'll try again shortly",
  'sync.conflicts.failedBody':
    "Your choice is safe and still counts. We just couldn't reach your account this time.",
  'sync.conflicts.failedRetry': 'Try now',
  'sync.conflicts.settledTitle': 'All set',
  'sync.conflicts.settledBody': 'This record now matches on this device and in your account.',
  'sync.conflicts.staleTitle': 'This changed again',
  'sync.conflicts.staleBody':
    "Your account has newer information than what you reviewed, so we didn't apply your choice. Have a look at the new version and choose again.",
  'sync.conflicts.staleAction': 'Review again',
  'sync.conflicts.restoreUnsupportedTitle': "We can't bring this one back",
  'sync.conflicts.restoreUnsupportedBody':
    "This record was deleted in your account, and keeping your version isn't possible for this kind of record. You can still keep the version saved in your account.",
  'sync.conflicts.alreadyResolvedTitle': 'Already decided',
  'sync.conflicts.alreadyResolvedBody':
    "This one was decided somewhere else first, so that choice is the one that stands. We've matched this device to it.",
  'sync.conflicts.choice.keepThisDevice': "Keep this device's version",
  'sync.conflicts.choice.keepThisDeviceDescription':
    'Your account will be updated to match what you see under "On this device".',
  'sync.conflicts.choice.keepThisDeviceAccessibility': 'Keep the version on this device',
  'sync.conflicts.choice.keepAccount': "Keep my account's version",
  'sync.conflicts.choice.keepAccountDescription':
    'This device will be updated to match what you see under "Saved in your account".',
  'sync.conflicts.choice.keepAccountAccessibility': 'Keep the version saved in your account',
  'sync.conflicts.choice.noChangeYet': 'Nothing changes until you choose.',
  'sync.conflicts.deletedElsewhereTitle': 'Deleted in your account',
  'sync.conflicts.deletedElsewhereBody':
    "This record was removed somewhere else. Keeping this device's version brings it back.",
  'sync.conflicts.value.hidden': 'Saved, not shown here',
  'sync.conflicts.value.absent': 'Not part of this change',
  'sync.conflicts.value.yes': 'Yes',
  'sync.conflicts.value.no': 'No',
  'sync.conflicts.value.notRecorded': 'Nothing recorded',
  'sync.conflicts.compare.same': 'Same on both',
  'sync.conflicts.compare.different': 'Different',
  ...
  'sync.conflicts.offlineTitle': "You're offline",
  'sync.conflicts.offlineBody':
    "You can still choose now. We'll save it on this device and finish when you're connected again.",
  'sync.conflicts.dashboardButton': 'Review changes',
  'sync.conflicts.dashboardButtonAccessibility': 'Review changes that need your decision',
  'sync.conflicts.record.user_profiles': 'Profile',
  'sync.conflicts.record.goals': 'Goal',
  'sync.conflicts.record.body_weights': 'Weight entry',
  'sync.conflicts.record.body_measurements': 'Body measurements',
  'sync.conflicts.record.progress_snapshots': 'Weekly summary',
  'sync.conflicts.record.dietary_preferences': 'Food preference',
  'sync.conflicts.record.meal_items': 'Food log entry',
  'sync.conflicts.record.exercises': 'Exercise',
  'sync.conflicts.record.routines': 'Routine',
  'sync.conflicts.record.routine_exercises': 'Exercise in a routine',
  'sync.conflicts.record.workout_logs': 'Workout',
  'sync.conflicts.record.workout_sets': 'Set',
  'sync.conflicts.record.wellness_safety_profiles': 'Wellness profile',
  'sync.conflicts.field.activity_level': 'Activity level',
  'sync.conflicts.field.affected_areas': 'Body areas to treat carefully',
  'sync.conflicts.field.avg_calories': 'Average calories',
  'sync.conflicts.field.avg_weight_kg': 'Average weight',
  'sync.conflicts.field.avoid_tag': 'Ingredient to avoid',
  'sync.conflicts.field.birth_date': 'Date of birth',
  'sync.conflicts.field.body_fat_pct': 'Body fat',
  'sync.conflicts.field.calories_per_serving_snapshot': 'Calories per serving',
  'sync.conflicts.field.carbs_per_serving_snapshot': 'Carbs per serving',
  'sync.conflicts.field.catalog_key': 'Food',
  'sync.conflicts.field.catalog_key_snapshot': 'Food chosen',
  'sync.conflicts.field.catalog_version_snapshot': 'Food list version',
  'sync.conflicts.field.category': 'Category',
  'sync.conflicts.field.chest_cm': 'Chest',
  'sync.conflicts.field.completed': 'Completed',
  'sync.conflicts.field.date': 'Date',
  'sync.conflicts.field.description': 'Description',
  'sync.conflicts.field.ended_at': 'Ended',
  'sync.conflicts.field.equipment': 'Equipment',
  'sync.conflicts.field.evaluation_completed': 'Professional evaluation completed',
  'sync.conflicts.field.evaluation_date': 'Date of the evaluation',
  'sync.conflicts.field.exclusion_type': 'Kind of exclusion',
  'sync.conflicts.field.fat_per_serving_snapshot': 'Fat per serving',
  'sync.conflicts.field.fiber_per_serving_snapshot': 'Fiber per serving',
  'sync.conflicts.field.finished_at': 'Finished',
  'sync.conflicts.field.fitness_level': 'Fitness level',
  'sync.conflicts.field.food_name_snapshot': 'Food name',
  'sync.conflicts.field.food_revision_snapshot': 'Food version',
  'sync.conflicts.field.gender': 'Gender',
  'sync.conflicts.field.goal_type': 'Goal type',
  'sync.conflicts.field.grams_per_serving_snapshot': 'Grams per serving',
  'sync.conflicts.field.height_cm': 'Height',
  'sync.conflicts.field.hip_cm': 'Hips',
  'sync.conflicts.field.instructions': 'Instructions',
  'sync.conflicts.field.is_active': 'Active',
  'sync.conflicts.field.is_deload_week': 'Lighter week',
  'sync.conflicts.field.kind': 'Kind',
  'sync.conflicts.field.left_arm_cm': 'Left arm',
  'sync.conflicts.field.movements_to_avoid': 'Movements to avoid',
  'sync.conflicts.field.muscle_group': 'Muscle group',
  'sync.conflicts.field.muscle_mass_kg': 'Muscle mass',
  'sync.conflicts.field.name': 'Name',
  'sync.conflicts.field.neck_cm': 'Neck',
  'sync.conflicts.field.note': 'Note',
  'sync.conflicts.field.notes': 'Notes',
  'sync.conflicts.field.occupation': 'Occupation',
  'sync.conflicts.field.order_index': 'Position in the routine',
  'sync.conflicts.field.protein_per_serving_snapshot': 'Protein per serving',
  'sync.conflicts.field.reps': 'Reps',
  'sync.conflicts.field.right_arm_cm': 'Right arm',
  'sync.conflicts.field.rpe': 'Effort',
  'sync.conflicts.field.rule_version': 'Calculation version',
  'sync.conflicts.field.serving_amount_snapshot': 'Serving size',
  'sync.conflicts.field.serving_count': 'Servings',
  'sync.conflicts.field.serving_unit_snapshot': 'Serving unit',
  'sync.conflicts.field.session_duration_mins': 'Session length',
  'sync.conflicts.field.set_number': 'Set number',
  'sync.conflicts.field.sleep_hours_baseline': 'Usual sleep',
  'sync.conflicts.field.started_at': 'Started',
  'sync.conflicts.field.stress_level_baseline': 'Usual stress',
  'sync.conflicts.field.target_calories': 'Calorie target',
  'sync.conflicts.field.target_carbs_g': 'Carb target',
  'sync.conflicts.field.target_date': 'Target date',
  'sync.conflicts.field.target_fat_g': 'Fat target',
  'sync.conflicts.field.target_protein_g': 'Protein target',
  'sync.conflicts.field.target_reps': 'Target reps',
  'sync.conflicts.field.target_sets': 'Target sets',
  'sync.conflicts.field.target_weight_kg': 'Target weight',
  'sync.conflicts.field.total_volume_kg': 'Total volume',
  'sync.conflicts.field.training_days_per_week': 'Training days per week',
  'sync.conflicts.field.waist_cm': 'Waist',
  'sync.conflicts.field.week_start': 'Week of',
  'sync.conflicts.field.weight_kg': 'Weight',
  'sync.conflicts.field.workout_count': 'Workouts',
