...
- **D4:** v1 trend metric scope. **Decision gate drafted 2026-08-03: recommends Option A (focused set — body-weight/waist trends + weekly snapshot summary primary; body-fat/other measurements + workout/nutrition adherence optional when deterministic local data exists; medical-trend/diagnostic/predictive/ML excluded) — pending owner acceptance; see ADR-P016 "D4 decision gate".** **D5:** iCoach interaction (feed, never override). **D6:** duplicate-date conflict semantics.
