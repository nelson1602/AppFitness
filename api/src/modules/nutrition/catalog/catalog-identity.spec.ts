...
const GOLDEN = [
  ...
  {
    key: 'food.dragon_fruit',
    revision: 2,
    id: 'a8fe6508-0d34-5d93-a6f2-d0209b876474',
  },
  {
    key: 'food.mixed_greens',
    revision: 2,
    id: 'd0b4acb4-2289-5fa0-b9be-da5aeabb8973',
  },
];
...
describe('serving snapshot derivation (server)', () => {
  it('derives the immutable per-serving snapshot for a known food', () => {
    ...
    expect(deriveServingSnapshot(chicken)).toEqual({
      ...
      catalogVersionSnapshot: 'food-catalog@1.13.6',
